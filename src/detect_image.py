...
# python detect_image.py --model custom-auto --image test/12.jpg --labels coco_classes.pickle
...
def get_auto_model(num_classes=2):
...
if __name__ == "__main__":
	...
	#TODO: instead of dealing with pickle files for now, just load categories direct from coco file
	...
	#TODO: load custom model from file

	MODELS = {
		"frcnn-resnet": detection.fasterrcnn_resnet50_fpn,
		"frcnn-mobilenet": detection.fasterrcnn_mobilenet_v3_large_320_fpn,
		"retinanet": detection.retinanet_resnet50_fpn,
		"custom-auto": get_auto_model(2)
	}
